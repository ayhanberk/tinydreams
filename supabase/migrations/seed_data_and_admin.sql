...
(uuid_generate_v4(), 'Yıldızlı Gece Lambası', 'Bebek odaları için huzurlu bir uyku ortamı sağlayan projeksiyonlu lamba.', 249.90, 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?q=80&w=800', 'Bebek Odası', 50, true),
...
(uuid_generate_v4(), 'Pamuklu Tulum', 'Yumuşacık dokusuyla bebeğinizin cildini tahriş etmeyen organik tulum.', 120.00, 'https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=800', 'Giyim', 100, false);
